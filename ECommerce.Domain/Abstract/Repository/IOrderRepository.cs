...
public interface IOrderRepository
{
    ...
    Task<List<Order>> GetAccountPendingOrders(Guid userId, CancellationToken cancellationToken = default);
    Task<Order> GetOrderById(Guid id, CancellationToken cancellationToken = default);
    Task<Order> GetOrderByAccountId(Guid userId, CancellationToken cancellationToken = default);
    Task<List<Order>> GetAccountOrders(Guid userId, CancellationToken cancellationToken = default);
