...
public interface IBasketItemRepository
{
    ...
    Task<List<BasketItem>?> GetNonOrderedBasketItemIncludeSpecificProduct(Guid productId, CancellationToken cancellationToken = default);
    Task<BasketItem?> GetSpecificAccountBasketItemWithId(Guid id, User account, CancellationToken cancellationToken = default);
